...
namespace Pushpay.SemVerAnalyzer.Tests
{
	public class FakeNugetClient : INugetClient
	{
		...
		public Task<byte[]> GetAssemblyBytesFromPackage(string packageName, string packageVersion, bool includePrerelease, string fileName, string framework, List<string> comments)
		{
